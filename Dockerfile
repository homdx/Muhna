...
RUN echo Python3 Nuhna && sudo mkdir app2 && sudo chown user app2 && cd app2 && git clone https://github.com/homdx/Muhna && cd Muhna && git checkout docker \
&& ANDROIDAP=28 ANDROIDNDKVER=r17c NDKAPI=21 GRADLE_OPTS="-Xms1724m -Xmx5048m -Dorg.gradle.jvmargs='-Xms1724m -Xmx5048m'" JAVA_OPTS="-Xms1724m -Xmx5048m" ANDROIDSDK=/sdk-install/ ANDROIDNDK="/ndk/" p4a apk --private .
